export default function Botom3() {
    return (
                    ...
                    <div className='paragraph-border'>
                        <div className='box-para'>
                            <div className='paragrapharabic fs-xxl-1 fs-xl-2 fs-lg-3 fs-md-4'>
                                <p>تتحقق فرادا من خلال توفير تشكيلة متنوعة من الأحذية والجزم والعديد من الإكسسوارات الرجالية عالية الجودة والأنيقة، تلبي احتياجات وتفضيلات الرجال في المملكة العربية السعودية. تعكس العلامة التجارية الرؤية والرسالة من خلال تصاميمها الفريدة والتفاصيل الدقيقة، وتسعى لتميز الرجال وزيادة ثقتهم الذاتية من خلال أناقتهم الشخصية. اختيار فرادا تعني الانتقال إلى عالم الأناقة والتميز.</p>
                            </div>
