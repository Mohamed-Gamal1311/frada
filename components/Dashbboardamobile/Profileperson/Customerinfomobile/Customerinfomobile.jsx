...
import './Customerinfomobile.css'
export default function Customerinfomobile() {
    return (
        <section className='Customerinfomobile' >
            <div>
                <form className="form-content-dashboard" >
                    ...
                    <h1 className='big-title' style={{ color: '#D17A52', marginLeft: '20%', marginBottom: '1%', fontSize: '22px' }}>الملف الشحصي</h1>
                                ...
                                <div className='link-customer-cont' >
                                    ...
                                    <div className='contactwith-us'>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                                            ...
                                            <Image className='face' src={facebookkk} alt='edit' />
