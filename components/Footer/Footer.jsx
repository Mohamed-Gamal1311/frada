                    ...
                    <div className='footer-cont'>
                        <div className='footer-flex'>
                            <div className='logo-footer'>
                                <div className='frada-log'><Image src={logofrada} style={{ width: '75%', marginRight: '15px', fill: 'white' }} /></div>
                            ...
                            <div className='footer-par1'>
                                <div className='map'><iframe width="85%" height="220px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=elmokatam%20Cairo+()&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                    ...
                    <div className='logo-saerchmo'>
                        <div className='logo-footer'>
                            ...
                            <div className='social-media'> <img src={snapchat} />
                                ...
                                <Image src={facebook} id='facebookkk' alt='facebook' />
                            </div>
