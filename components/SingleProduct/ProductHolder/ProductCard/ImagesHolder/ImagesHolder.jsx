                ...
                <div className='subimage-holder'>
                    ...
                    {props.images.length > 0 ? props.images.map((image, index) => (
                        <div key={index} className='image-hover' onMouseEnter={() => handlePhotoHover(`https://www.fradaksa.net/back/Laravel/public/Attachment/${props.id}/${props.colorid}/${image}`)}>
                            <Image key={index} src={`https://www.fradaksa.net/back/Laravel/public/Attachment/${props.id}/${props.colorid}/${image}`} width={80} height={80} alt={"IMAGE"} className="ml-2" />
                        </div>
                    )) : (<div>none</div>)}
                    ...
                    {props.images.length > 0 ? props.images.map((image, index) => (
                        <Carousel.Item>
                            ...
                            <Carousel.Caption>
                                ...
                                <Image key={index} src={`https://www.fradaksa.net/back/Laravel/public/Attachment/${props.id}/${props.colorid}/${image}`} width={350} height={350} alt={"IMAGE"} className="ml-2" />
                            </Carousel.Caption>
                        </Carousel.Item>
                    )) : (<div>none</div>)}
                </Carousel>
